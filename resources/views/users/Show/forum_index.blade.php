...
<section id="services" class="services section-bg">
    ...
    <div class="container-sm mt-5">
        <h3 class="text-center"> Forum Tanaman PlantDoc 2021</h3>
        <hr>
        <div class="row">
                ...
                <form action="{{route ('forum_post') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Jenis Tanaman</label>
                            <select class="form-control" id="exampleFormControlSelect1" name="tittle_forum">
